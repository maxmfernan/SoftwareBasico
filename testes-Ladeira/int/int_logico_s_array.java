 ...
 */
public class int_logico_s_array {
	public static void main(String args[]){
		int a=10; /*1010*/
		int b=9;  /*1001*/
		int array0 = 5, array1 = 5, array2 = 6;
		int c = 0;
		int d = -1;
		...
		if(array0==array1) System.out.println("indice 0 igual a indice 1");
		if(array0!=array2) System.out.println("indice 0 diferente de indice 2");
